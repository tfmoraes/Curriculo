...
%%% Social
\email{tfmoraes@gmail.com}
\github{github.com/tfmoraes/}
\bitbucket{bitbucket.org/tfmoraes/}
\linkedin{tfmoraes}
%%% Optionals
\position{Engenheiro de Software{\enskip\cdotp\enskip}Computação gráfica {\enskip\cdotp\enskip} Processamento de Imagens}
